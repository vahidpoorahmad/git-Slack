...
function DirectMessageContent(props) {
            ...
            <div className="main-general__header--top-left">
              ...
              <button className="main-general__header--title">
                <span className="main-general__header--title-text">
                  {filterItems[0].email.substring(
                    0,
                    filterItems[0].email.lastIndexOf("@")
                  )}
                </span>
        ...
        <div className="main-general__body">
          <div className="main-general__body--Description">
            <div className="main-general__body--Description--icon">
              <button className="main-general__body--Description--icon-btn">
                <FontAwesomeIcon icon={faUser} />
              </button>
            </div>
...
const mapStateToProps = (state) => {
  return {
    domin: state.DirectMessageReducer,
  };
};
export default connect(mapStateToProps)(DirectMessageContent);
